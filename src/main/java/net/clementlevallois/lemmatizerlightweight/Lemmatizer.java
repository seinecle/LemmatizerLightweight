    ...
    public String lemmatize(String term) {
        ...
        if (lang.equals("en")) {
            if (term.endsWith("ies")) {
                ...
                if (term.endsWith("lked") || term.endsWith("cked") || term.endsWith("ssed") || term.endsWith("lled") || term.endsWith("lled") || term.endsWith("red") || term.endsWith("ned") || (term.endsWith("ted") & !term.endsWith("ated"))) {
                    term = term.substring(0, term.length() - 2);
                } else if (term.endsWith("ied")) {
                    term = term.substring(0, term.length() - 3) + "y";
                } else if (term.endsWith("rred")) {
